...
public class ShippingpricesApi {
  ...
  public ShippingpricesApi() {
    this(Configuration.getDefaultApiClient());
  }

  public ShippingpricesApi(ApiClient apiClient) {
  ...
  public ShippingPricesResult pOSTShippingprices(ShippingPricesRequest shippingPricesRequest) throws ApiException {
    ...
    GenericType<ShippingPricesResult> localVarReturnType = new GenericType<ShippingPricesResult>() {};
