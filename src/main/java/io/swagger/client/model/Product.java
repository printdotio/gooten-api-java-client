...
public class Product   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, uId, name, shortDescription, hasAvailableProductVariants, hasProductTemplates, featuredIndex, maxZoom, retailPrice, info, productImage, priceInfo, categories);
  }
